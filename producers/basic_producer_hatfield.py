...
ADJECTIVES: list = ["happy", "dazzling", "quick", "brave", "sad"]
ACTIONS: list = ["sleeping", "dancing", "walking", "jumping", "playing"]
NOUNS: list = ["dog", "child", "music", "street", "office"]
...
def generate_messages():
    ...
    while True:
        ...
        yield f"I left the {action} {nouns}! I was {adjective}."
